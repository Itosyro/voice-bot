...
- **Длинные ответы** (>3900 символов) разбиваются на несколько сообщений по границам абзацев — не обрезаются.
- **Groq API** — retry 1 раз с паузой 2 сек при любой ошибке (обрывы, 500, временные сбои).
