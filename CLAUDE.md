...
python -m pytest tests/ -q                       # 89 тестов
...
- [ ] Сессия БД точечно, а не на всю обработку (пул под нагрузкой; критик Б2)
- [ ] Дедуп конкурирующих «Ещё вариант» (row-lock кэша; критик Б6)
- [ ] Кэш транскрипта для чанкового пути; очередь на пользователя;
      склейка нескольких голосовых подряд
