...
python -m pytest tests/ -q                       # 80 тестов
...
- [ ] **Мульти-провайдерный фолбэк**: Cerebras (LLM, 1M ток./день free) и
      SambaNova (Whisper STT) как запасные OpenAI-совместимые провайдеры
- [ ] Экспорт .txt из полного текста последнего ответа (сейчас — только видимая часть)
