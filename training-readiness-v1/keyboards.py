...
def main_menu() -> InlineKeyboardMarkup:
    return kb([
        ...
        [("🏋️ Тренировки", "menu:training"), ("🗓 Неделя", "menu:week")],
        [("➕ Событие", "menu:event"), ("🗂 Расписание", "menu:schedule")],
        [("➕ Повтор", "menu:repeat"), ("🔁 Мои повторы", "menu:repeats")],
        [("⚙️ Настройки", "menu:settings"), ("🧯 Я залип", "menu:zalip")],
    ])
